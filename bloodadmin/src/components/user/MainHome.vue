<template>
  <div class="flex flex-col justify-center text-white font-extrabold items-center h-screen -z-40" :style="{
    'background-image': `url(${mainImage})`,
    'background-size': 'cover',
    'background-position': 'center',
    'z-index': '-1',
  }">
    <div class="text-2xl text-center sm:text-4xl md:text-5xl b w-[90%] lg:w-[80%]">
      <h3>Saving lives doesn't have to A lot of things hurt.</h3>
    </div>
    <div class="mt-20 w-[90%] mx-auto px-2 py-2 bg-white border-2 border-red-400 rounded-lg lg:w-[60%]">
      <form @submit.prevent="searchDonor" action="">
        <div class="flex md:justify-between flex-col sm:flex-col md:flex-row">
          <div class="flex flex-row border-b border-black w-full mx-2 lg:mx-4">
            <div>
              <img class="h-8 w-8" src="@/assets/img/bloodpoint.png" alt="icon point blood" />
            </div>
            <div class="w-full">
              <select v-model='selectBlood'

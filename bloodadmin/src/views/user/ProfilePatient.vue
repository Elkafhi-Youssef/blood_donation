        ...
        <div class=" flex justify-center">
          ...
          <div class=" mb-5 flex justify-center">
              <ul class=" flex justify-center border-b-2 border-second_col w-fit ">
                  <li class="block  border-gray-100 md:border-0 md:p-0 hover:text-second_col  mx-2 cursor-pointer"><router-link to="/profilepatient/newrequestspatient"> New</router-link></li>
                  <li class="block  border-gray-100 md:border-0 md:p-0 hover:text-second_col  mx-2 cursor-pointer"><router-link to="/profilepatient/appointmentrequestspatient"> Appointments</router-link></li>
                  <li class="block  border-gray-100 md:border-0 md:p-0 hover:text-second_col  mx-2 cursor-pointer"><router-link to="/profilepatient/cancelrequestspatient"> Canceled</router-link></li>        
              </ul>
          </div>

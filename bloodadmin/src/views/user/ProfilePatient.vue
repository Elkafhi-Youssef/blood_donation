<template>
  <div>
    <Header />
    <div 
      class=" relative  my-8 mx-auto min-w-[370px]  flex flex-col md:flex-row items-center  bg-white rounded-lg shadow-lg w-[90%]">
   
      
         
        <button
          class=" absolute top-0 right-0 text-black  hover:text-white  bg-third_col hover:bg-second_col py-2 px-4 rounded mx-1 mb-2  text-sm">
        <router-link :to="`/updateprofile/${profileuser.user_id}`"  > update</router-link>
      ...
      <div class=" md:w-[45%]  flex flex-col md:flex-col-reverse">
        ...
        <div class="mt-4 flex justify-center">
          <img class="mx-auto h-40 w-40 object-cover rounded-full md:rounded-sm" :src="'http://127.0.0.1/BLOOD_DONATION/backendAPI/public/imgsProfile/'+profileuser.image" alt="image user" />
        </div>
      </div>
    ...
    <div class="  ">
      ...
      <div class=" mb-5 flex justify-center">
        <ul class=" flex justify-center border-b-2 border-second_col w-fit ">
          <li class="block  border-gray-100 md:border-0 md:p-0 hover:text-second_col  mx-2 cursor-pointer">
            <router-link to="/profilepatient/newrequestspatient"> New</router-link>
          </li>
          <li class="block  border-gray-100 md:border-0 md:p-0 hover:text-second_col  mx-2 cursor-pointer">
            <router-link to="/profilepatient/appointmentrequestspatient"> Appointments</router-link>
          </li>
          <li class="block  border-gray-100 md:border-0 md:p-0 hover:text-second_col  mx-2 cursor-pointer">
            <router-link to="/profilepatient/cancelrequestspatient"> Canceled</router-link>
          </li>
        </ul>
      </div>
